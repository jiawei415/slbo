...
class HopperEnv(hopper_env.HopperEnv, BaseModelBasedEnv):
    def __init__(
        self, version="v1", alive_coeff=1, ctrl_cost_coeff=0.01, *args, **kwargs
    ):
        super().__init__(version, alive_coeff, ctrl_cost_coeff, *args, **kwargs)
    ...
    def mb_step(self, states, actions, next_states):
        ...
        reward = (
            ...
            (next_states[:, 3:12] < 100).all(axis=-1)
            & (next_states[:, 0] > 0.7)
